...
namespace gpack{
        namespace detail{
                ...
                struct to_string_visitor : boost::static_visitor<void>
                {
                        ...
                        void operator()(binary_ const& )const{
                                ctx_->put( "(binary_...)" );
                        }
                        void operator()(ref_ const& ref)const{
                                ctx_->put( str( boost::format("<ref %i>") % ref.index() ) );
                        }
                        void operator()(insert_ const& insert)const{
                                ctx_->put( str( boost::format("<insert %i>") % insert.count() ) );
                                boost::apply_visitor( *this, insert.get() );
                        }
                private:
                        Context* ctx_;
                };
        ...
        inline
        std::string to_string(variant_t const& root){
        ...
        inline
        void display(variant_t const& root, std::ostream& ostr = std::cout){
        ...
        inline
        std::ostream& operator<<(std::ostream& ostr, variant_t const& vt){
                return ostr << to_string(vt);
        }
}
